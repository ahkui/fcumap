...
class Dijkstra{
    ...
    init() {
        ...
        addListQueue.async {
            ...
            self.add(key: "ti",name:"體育館主要路口",lat:24.181498,long:120.649048,next:["yundongchang","p1","p22"])
            self.add(key: "chuang",name:"創客中心",lat:24.179714,long:120.649153,next:["p23","p21"])
            ...
            self.add(key: "xuesi1",name:"學思樓側一",lat:24.181622,long:120.646785,next:["xuesi3","xuesi2","p28"])
            self.add(key: "xuesi2",name:"學思樓側二",lat:24.181368,long:120.646603,next:["p25","xuesi1","xuesi"])
            self.add(key: "xuesi",name:"學思樓大門",lat:24.181501,long:120.646807,next:["xuesi3","xuesi2","p28"])
            self.add(key: "out_bei",name:"學園出口（北門）",lat:24.181906,long:120.648203,next:["p22","p27"])
            self.add(key: "xuesi3",name:"學思樓側三",lat:24.181774,long:120.646641,next:["xuesi1","out_mos1","xuesi","p27"])
            ...
            self.add(key: "li",name:"理學大樓大門",lat:24.18118,long:120.647412,next:["p28"])
